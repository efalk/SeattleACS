...
* W7ACS\_ICS-217A\_20230505.csv     Seattle ACS ics-217 frequency list
* W7ACS\_ICS-217A\_20240131.csv     Seattle ACS ics-217 frequency list

* Chirp/		Programming files for Chirp
* RT/		Programming files for RT Systems
* Icom/		Programming files for Icom

Note: it is very easy to add new formats. If you have software that
won’t accept one of these three, please contact me at KK7NNS au
gmail.com; it’s easier to add a new output format than it would be
for you to manually enter the data,
